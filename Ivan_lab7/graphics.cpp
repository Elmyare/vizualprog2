...
Graphics::Graphics(QObject* parent):QGraphicsScene (parent)
{
    ...
    QPixmap newImage;
    if (!newImage.load(QStringLiteral("C:\\Users\\ivanl\\Documents\\vizlabs\\Ivan_lab7\\images\\torch.png")))return;
    ...
    if (!newImage.load(QStringLiteral("C:\\Users\\ivanl\\Documents\\vizlabs\\Ivan_lab7\\images\\knight.png")))return;
